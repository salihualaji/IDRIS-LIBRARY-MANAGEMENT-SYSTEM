...
<body>
    ...
    <div class="pageArea">
        ...
        <div class='hangingPreview'>
            <div class='closeScrn' onclick="closeBtn();"><i class='fa-solid fa-circle-xmark'></i></div>
            ...
            while ($db_field = mysqli_fetch_assoc($result)) {
                ...
                $book_isbn = $db_field['book_isbn'];
                $book_quantity = $db_field['book_quantity'];
    ...
    <div class='bookbriefHolder'>
        ...
        <table>
            ...
            <tr>
                <td><i class='fa-solid fa-user-pen'></i> Author:</td>
                <td> $book_author</td>
            </tr>

            <tr>
                <td><i class='fa-regular fa-clock'></i> Published date:</td>
                <td> $published_date</td>
            </tr>

            <tr>
                <td><i class='fa-solid fa-pen-nib'></i>  Genre:</td>
                <td> $book_genre</td>
            </tr>

            <tr>
                <td><i class='fa-solid fa-shield-halved'></i>  ISBN:</td>
                <td> $book_isbn</td>
            </tr>
        </table>
        
        <p><span>$book_quantity copies available</p>

        <h3>About this book</h3>
        <p>$book_brief <span onclick='continueReading()'><u>Learn more</u></span></p>";


            if ($book_status == "Borrowed") {
                echo "<div class='simpleControl'>
            <div class='Borrowbtn'> <a href='#'>This book was borrowed by one of our readers </a> </div>
        </div>";
            } else {
                echo "<div class='simpleControl'>
            <div class='Borrowbtn'><a href='borrow_book.php?book_id=$book_id'>Borrow Book</a></div>
        </div>";
            }
            echo "</div>
</div>";
    ...
    <hr>";
            ...
            <div class='detailPage'>
                <h2>$book_title</h2>
                <p><i class='fa-solid fa-user-pen'></i> Author: <span>$book_author</span></p>
                <p><i class='fa-regular fa-clock'></i> ISBN: <span>$book_isbn</span></p>
